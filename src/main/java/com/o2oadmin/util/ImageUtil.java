...
public class ImageUtil {
     ...
     * @return
     */
    public static String generateThumbnailheadline(ImageHolder thumbnail, String targetAddr) {
        ...
        try {
            Thumbnails.of(thumbnail.getImage()).size(1600, 900)
     ...
     * @return
     */
    public static String generateThumbnailshopcate(ImageHolder thumbnail, String targetAddr) {
        String realFileName = getRandomFileName();
        String extension = getFileExtension(thumbnail.getImageName());
        makeDirPath(targetAddr);
        String relativeAddr = targetAddr + realFileName + extension;
